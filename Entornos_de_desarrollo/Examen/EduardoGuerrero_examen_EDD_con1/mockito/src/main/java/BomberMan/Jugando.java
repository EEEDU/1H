...
// noseve.drawString("" + Bomba.bomba.get(i).cuadranteDiferente, 100 + (i * 50),
// 100);
// }
	...
	public void setAnimacion(Thread animacion) {
	...
	public static Graphics getNoseve() {
		return noseve;
	}

	public static void setNoseve(Graphics noseve) {
		Jugando.noseve = noseve;
	}
	...
	public static int getLongitudImagenX() {
		return longitudImagenX;
	}

	public static void setLongitudImagenX(int longitudImagenX) {
		Jugando.longitudImagenX = longitudImagenX;
	}

	public static int getLongitudImagenY() {
		return longitudImagenY;
	}

	public static void setLongitudImagenY(int longitudImagenY) {
		Jugando.longitudImagenY = longitudImagenY;
	}

	public static int getDimensionBloques() {
		return dimensionBloques;
	}

	public static void setDimensionBloques(int dimensionBloques) {
		Jugando.dimensionBloques = dimensionBloques;
	}
